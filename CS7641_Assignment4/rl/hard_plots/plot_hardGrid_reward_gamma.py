...
action_file = 'hard_gamma_reward.csv'
...
with open(action_file,'r') as fr:
	...
	content_tmp = fr.readline()
	valueI_action5 = content_tmp[16:-1].split(",")
	...
	content_tmp = fr.readline()
	policyI_action5 = content_tmp[17:-1].split(",")
...
valueI_action1 = [float(numeric_string) for numeric_string in valueI_action1]
valueI_action2 = [float(numeric_string) for numeric_string in valueI_action2]
valueI_action3 = [float(numeric_string) for numeric_string in valueI_action3]
valueI_action4 = [float(numeric_string) for numeric_string in valueI_action4]
valueI_action5 = [float(numeric_string) for numeric_string in valueI_action5]
...
plt.plot(range(1,201), valueI_action5, color ='m', linewidth ='1',label='gamma 0.98')
...
policyI_action1 = [float(numeric_string) for numeric_string in policyI_action1]
policyI_action2 = [float(numeric_string) for numeric_string in policyI_action2]
policyI_action3 = [float(numeric_string) for numeric_string in policyI_action3]
policyI_action4 = [float(numeric_string) for numeric_string in policyI_action4]
policyI_action5 = [float(numeric_string) for numeric_string in policyI_action5]
...
plt.plot(range(1,201), policyI_action5, color ='m', linewidth ='1',label='gamma 0.98')
plt.xlabel('Policy Iterations',  fontsize = 13)
plt.ylabel('Reward',  fontsize = 13)
# plt.legend(('EM', 'Kmeans'), loc = 4, fontsize = 13)
plt.ylim(-1000,100)
#plt.xlim(0,500)
