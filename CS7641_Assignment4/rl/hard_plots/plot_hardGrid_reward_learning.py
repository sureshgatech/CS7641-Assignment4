...
action_file = 'hard_learning_reward.csv'
...
plt.plot(range(1,201), Q_action1, color ='g', linewidth ='1', label='learningrate 0.1')
plt.plot(range(1,201), Q_action2, color ='b', linewidth ='1', label='learningrate 0.3')
plt.plot(range(1,201), Q_action3, color ='r', linewidth ='1', label='learningrate 0.5')
plt.plot(range(1,201), Q_action4, color ='y', linewidth ='1', label='learningrate 0.7')
#plt.plot(range(1,201), Q_action4, color ='m', linewidth ='1', label='learningrate 0.9')
