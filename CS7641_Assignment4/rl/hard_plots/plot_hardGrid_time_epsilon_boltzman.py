...
action_file = 'hard_learning_time_boltzman.csv'
...
plt.plot(range(1,1001), Q_action4, color ='m', linewidth ='1', label='Temperature 0.9')
plt.xlabel('Q Learning Iterations',  fontsize = 13)
plt.ylabel('Boltzman Time',  fontsize = 13)
