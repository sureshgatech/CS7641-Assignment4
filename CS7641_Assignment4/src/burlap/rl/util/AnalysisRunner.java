...
public class AnalysisRunner {
	...
	public void runValueIteration(BasicGridWorld gen, Domain domain,
			State initialState, RewardFunction rf, TerminalFunction tf, boolean showPolicyMap, double gamma) {
	...
	public void runQLearning(BasicGridWorld gen, Domain domain,
			...
			SimulatedEnvironment env, boolean showPolicyMap, double gamma) {
		...
		//	Policy policy = new EpsilonGreedy(agent, gamma);
	//		Policy policy = new GreedyDeterministicQPolicy(agent);
			Policy policy = new BoltzmannQPolicy(agent, gamma);
